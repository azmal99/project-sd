...
Route::get('/kelas/show-kelas', [App\Http\Controllers\MapelController::class, 'indexKelas']);
Route::get('/kelas/show/{id}', [App\Http\Controllers\KelasController::class, 'show']);
Route::get('/kelas/showByMapel/{kelas_id}', [App\Http\Controllers\KelasController::class, 'showByMapel']);
...
Route::get('/mata-pelajaran/show-mapel', [App\Http\Controllers\MapelController::class, 'indexMapel']);
...
Route::get('/mata-pelajaran/showByGuru/{kd_guru}', [App\Http\Controllers\MapelController::class, 'showByGuruId']);
Route::get('/mata-pelajaran/showByKelas/{kelas_id}', [App\Http\Controllers\MapelController::class, 'showByKelasId']);
...
Route::get('/rapot/exportPdfRapot', [App\Http\Controllers\RapotController::class, 'exportPdfRapot']);
Route::get('/rapot/exportPdfBySiswa/{siswa_id}', [App\Http\Controllers\RapotController::class, 'exportPdfBySiswa']);
Route::get('/rapot/exportPdfByMapel/{mapel_id}', [App\Http\Controllers\RapotController::class, 'exportPdfByMapel']);
...
Route::get('/nilai-pengetahuan/show/{siswa_id}', [App\Http\Controllers\NilaiPengetahuanController::class, 'show']);
...
Route::get('/nilai-keterampilan/show/{siswa_id}', [App\Http\Controllers\NilaiKeterampilanController::class, 'show']);
...
Route::get('/nilai-tugas/show/{siswa_id}', [App\Http\Controllers\NilaiTugasController::class, 'show']);
